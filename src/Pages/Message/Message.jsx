...
import SearchUser from "../../Components/RightPart/SearchUser";
    ...
    <>
     <Fragment>
        <Grid className="h-screen overflow-y-hidden" container>
          <Grid className="px-5 bg-[#cbabf5] " xs={3} item>
            <div className="flex h-full justify-between space-x-2">
              <div className="w-full">
                <div onClick={handleExit} className="flex space-x-4 items-center py-5 ">
                  <WestIcon />
                  ...
                  <div className="h-full space-y-4 mt-5 overflow-y-scroll hideScrollbar ">
                    {chat.chats.map((item) => (
                      <div
                        ...
                        className="cursor-pointer bg-[#cacfe3] rounded-md"
                      >
          ...
          <Grid className="h-full" item xs={9}>
            {currentChat ? (
              <div>
                <div className="flex justify-between items-center bg-[#cbabf5] border-l  p-5">
                ...
                <div className="sticky bottom-0 border-l ">
                  ...
                  <div className="bg-[#cbabf5] py-5 flex items-center justify-center space-x-5  ">
                    <input
                      onKeyPress={(e) => {
                        if (
                          e.key === "Enter" &&
                      ...
                      className="bg-white border first-letter: border-[#3b4054] rounded-full w-[90%] py-3 px-5 "
                      type="text"
